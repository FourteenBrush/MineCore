...
public class BlastingRecipeImpl extends BlastingRecipe {
    public BlastingRecipeImpl(String recipeId, String group, DeclareRecipesPacket.Ingredient ingredient, ItemStack result, float experience, int cookingTime) {
    ...
    public String toString() {
        return "BlastingRecipeImpl{recipeId=" + getRecipeId() + '}';
    }
}
